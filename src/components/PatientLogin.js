...
class PatientLogin extends Component{
    ...
    onSubmit = (event) => {
        ...
        this.state.contract.methods.setDetails(event.target[0].value, event.target[1].value, event.target[2].value, event.target[3].value,
            event.target[4].value, event.target[5].value, event.target[6].value, event.target[7].value, event.target[8].value )
